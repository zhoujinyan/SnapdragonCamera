...
public class CameraSettings {
    ...
    //arcsoft
    public static final String KEY_ARCSOFT_BEAUTY_PARAM         = "beauty-a"; // enable/disable
    public static final String KEY_ARCSOFT_BEAUTY_PARAM_WHITEN  = "white-level"; // 0~100
    public static final String KEY_ARCSOFT_BEAUTY_PARAM_SOFTEN   = "soften-level";  // 0~100
    public static final String KEY_ARCSOFT_BEAUTY_PARAM_SLENDER  = "slender-level"; // 0~100
    public static final String KEY_ARCSOFT_BEAUTY_PARAM_ENLARGEMENT   = "enlargement-level";  // 0~100
    public static final String KEY_ARCSOFT_BEAUTY_LEVEL         = "pref_camera_beauty_level_key";
    public static final String KEY_ARCSOFT_BEAUTY_LEVEL_WHITEN  = "pref_camera_beauty_whiten";
    public static final String KEY_ARCSOFT_BEAUTY_LEVEL_SOFTEN   = "pref_camera_beauty_soften";
