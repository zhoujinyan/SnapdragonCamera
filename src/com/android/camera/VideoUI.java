...
//        });
        ...
        RotateImageView filterModeButton = (RotateImageView)mRootView.findViewById(R.id.filter_mode_switcher);
        filterModeButton.setVisibility(View.GONE);
...
//        mSwitcher.closePopup();
    ...
    public void setSwitcherIndex() {
        mSwitcher.renderSelection(ModuleSwitcher.VIDEO_MODULE_INDEX);
    }
...
// no customvideo?
	...
	mGestures.setCurModeIndex(ModuleSwitcher.VIDEO_MODULE_INDEX);
	...
	public void showOrHideFlashButton(int cameraId) {
		mVideoMenu.showOrHideFlashButton(cameraId);
	}
    ...
    public boolean sendTouchToPreviewMenu(MotionEvent ev) {
        ev.offsetLocation(0, -(mVideoMenu.getPreviewMenuSize() - 70));
    ...
    public void showPopup(ListView popup, int level, boolean animate) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){mVideoMenu.handleBackKey();}
        });
        ...
        if (level == 1) {
            if (mMenuLayout == null) {
                ...
                // layoutParams.topMargin = mCameraControls.getMenuSize() - 20;
...
//        }
    ...
    public void enableFrontBackSwitcher(boolean enable){
        mVideoMenu.enableFrontBackSwitcher(enable);
    }
}
