...
public class VideoMenu extends MenuController
    ...
    public void initSwitchItem(final String prefKey, View switcher) {
	 ...
	 public void updateFlashModeIcon(int index) {
        TypedArray mTypedArray;
		boolean front = (mCameraId != 0);
		if(front) {
    ...
    public void initFlashModeButton(View button) {
		...
		if(pref.getValue().equalsIgnoreCase("off")) {
			updateFlashModeIcon(0);
			flashIsOn = false;
		} else if(pref.getValue().equalsIgnoreCase("torch")) {
			updateFlashModeIcon(2);
			flashIsOn = true;
		}
    ...
    public void onSettingChanged(ListPreference pref) {
		Log.d(TAG,"onSettingChanged KEY:"+pref.getKey()+",VALUE:"+pref.getValue());
