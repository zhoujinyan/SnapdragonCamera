...
public class FocusOverlayManager {
	...
	private boolean isShuttButton = false;
    ...
    public void onShutterDown() {
        ...
        if (needAutoFocusCall()) {
            ...
            if (mState != STATE_SUCCESS && mState != STATE_FAIL) {
				Log.d(TAG,"onShutterDown autoFocus");
				isShuttButton = true;
                autoFocus();
    ...
    public void onShutterUp() {
        ...
        if (needAutoFocusCall()) {
            ...
            if (mState == STATE_FOCUSING || mState == STATE_SUCCESS
                    || mState == STATE_FAIL) {
                Log.d(TAG,"onShutterUp autoFocus");
                cancelAutoFocus();
            }
        }
    ...
    public void onAutoFocusMoving(boolean moving) {
        ...
        Log.d(TAG,"onAutoFocusMoving mPreviousMoving:"+mPreviousMoving+",moving:"+moving);
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        mListener.setFocusParameters();
		Log.d(TAG,"onSingleTapUp mFocusAreaSupported:"+mFocusAreaSupported);
        if (mFocusAreaSupported) {
            autoFocus();
    ...
    public void updateFocusUI() {
		...
		Log.d(TAG,"updateFocusUI STATE_FOCUSING mState:"+mState);
        if (mState == STATE_IDLE) {
            if (mFocusArea == null) {
                ...
                Log.d(TAG,"updateFocusUI isShuttButton:"+isShuttButton);
                if(!isShuttButton) {
					mUI.onFocusStarted();
				}  else{
					isShuttButton = false;
         ...
         Log.d(TAG,"updateFocusUI STATE_FOCUSING isShuttButton:"+isShuttButton+",mState:"+mState);
             if(!isShuttButton) {
					mUI.onFocusStarted();
			  }  else{
					isShuttButton = false;
