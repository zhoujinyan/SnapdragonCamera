...
/**
 * Created by zhoujy on 27/11/17.
 */
public class RotatableUtil implements View.OnTouchListener {

	private static final String TAG = "RotatableUtil";
    ...
    public void rotate(final int direction, float degree, int duration, Animator.AnimatorListener listener) {
		...
		animatorSet.setInterpolator(new AccelerateInterpolator(1.25f));
		ObjectAnimator scaleAnimatorY = ObjectAnimator.ofFloat(rootView, "scaleY", 1.0f, 0.85f, 1.0f);
		ObjectAnimator scaleAnimatorX = ObjectAnimator.ofFloat(rootView, "scaleX", 1.0f, 0.9f, 1.0f);
        ArrayList<Animator> animators = new ArrayList<>();
		if(CameraUtil.getPreDegree() != degree) {
			animators.add(scaleAnimatorY);
			CameraUtil.setPreDegree(degree);
		}
		//animators.add(scaleAnimatorX);
    ...
    /**
     * Returns currentVisibleView value as {@link RotatableUtil.Side}
     */
    public
    @Side
