...
public class TsMakeupManager implements OnSeekBarChangeListener {
    ...
    //public static final String MAKEUP_ON     = "enable";
    // public static final String MAKEUP_OFF    = "Off";
   // public static final String MAKEUP_OFF    = "disable";
    ...
    public void hideMakeupUI() {
        ...
        if(getMakeUpOn().equals(tsMakeupOn)) {
            ...
            ImageView iv = (ImageView) mTsMakeupSwitcher;
            iv.setImageResource(((IconListPreference) pref).getLargeIconIds()[index]);
            mMakeupLevelListener.onMakeupLevel(CameraUtil.isTsMakeUp ? CameraSettings.KEY_TS_MAKEUP_LEVEL : CameraSettings.KEY_ARCSOFT_BEAUTY_LEVEL, pref.getValue());
...
//            rootParams.leftMargin = margin;
        ...
        if(MAKEUP_NONE.equals(value)) {
            ...
            layout.findViewById(R.id.id_layout_makeup_whiten).setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    seekBar.setProgress(getPrefValue(CameraUtil.isTsMakeUp ? CameraSettings.KEY_TS_MAKEUP_LEVEL_WHITEN : CameraSettings.KEY_ARCSOFT_BEAUTY_LEVEL_WHITEN));
                    mMode = MODE_WHITEN;
                    setSingleView(layout);
                }
            });
            ...
            layout.findViewById(R.id.id_layout_makeup_clean).setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    seekBar.setVisibility(View.VISIBLE);
                    seekBar.setProgress(getPrefValue(CameraUtil.isTsMakeUp ? CameraSettings.KEY_TS_MAKEUP_LEVEL_CLEAN : CameraSettings.KEY_ARCSOFT_BEAUTY_LEVEL_SOFTEN));
                    mMode = MODE_CLEAN;
                    setSingleView(layout);
                }
            });
    ...
    private void setSingleView(LinearLayout layout) {
        if(mSingleSelectedIndex == MODE_WHITEN) {
            ...
            ((TextView)layout.findViewById(R.id.id_txt_makeup_whiten)).setTextColor(mActivity.getColor(R.color.popup_title_color));
            ((TextView)layout.findViewById(R.id.id_txt_makeup_clean)).setTextColor(mActivity.getColor(android.R.color.white));
            ...
            ((TextView)layout.findViewById(R.id.id_txt_makeup_whiten)).setTextColor(mActivity.getColor(android.R.color.white));
            ((TextView)layout.findViewById(R.id.id_txt_makeup_clean)).setTextColor(mActivity.getColor(R.color.popup_title_color));
        }
    }
